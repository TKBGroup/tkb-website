...
export default function ContactForm({
    ...
    const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // KEY FIX 2: Set the submitted state to true
        setIsSubmitted(true);
    };
    ...
    return (
        <>
            ...
            <div onClick={isInline ? undefined : handleBackdropClick} className={wrapperClasses}>
                ...
                {/* KEY FIX 3: Use AnimatePresence to switch between the form and the thank you message */}
                <AnimatePresence mode="wait">
                    {isSubmitted ? (
                        <ThankYouMessage key="thank-you" onClose={onClose} />
                    ) : (
                        <form
                            key="contact-form"
                            onSubmit={handleFormSubmit}
                            className="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-8">
